...
### 16. AI 응답 톤 커스터마이징 (2026-03-11)
- [x] DB: user_profiles에 ai_tone 컬럼 추가 (migration 015)
- [x] 백엔드: validateAiTone 검증, 프로필 PATCH 지원, 분석 시 톤별 프롬프트 변경
- [x] 프론트엔드: 프로필 설정에 4종 톤 선택 UI (따뜻한 위로/전문 상담/다정한 친구/감성 시인)
